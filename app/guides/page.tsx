...
export default function GuidesPage() {
  return <div className="publication-page">
    <PageIntro label="CANOD practical guides" title="Understand the details. Choose with purpose."><p>Clear Canadian guidance for work, storage and portable setups. Start with what you need, then weigh the trade-offs.</p></PageIntro>

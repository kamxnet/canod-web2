...
export const metadata = pageMetadata("Practical Technology Guides", "Research-based Canadian guides to USB-C docks, storage, backups and portable work. Understand compatibility, fit and trade-offs before buying.", "/guides/");

export default function GuidesPage() {
  return <div className="publication-page">
    <PageIntro label="CANOD practical guides" title="Understand the details. Choose with purpose."><p>Clear Canadian guidance for work, storage and portable setups, with safety checks before you connect. Start with what you need, then weigh the trade-offs.</p></PageIntro>

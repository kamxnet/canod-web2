  ...
  return <>
    <section className="hero-shell">
      ...
      <div className="site-container relative z-10 flex min-h-[720px] items-center py-24 md:min-h-[790px]">
        <div className="max-w-[700px] pt-12">
          ...
          <div className="mt-10 flex flex-wrap gap-4"><Link className="button button-light" href="/about">Our approach <ArrowRight size={17} /></Link><Link className="button button-ghost" href="/partners">For brands</Link></div>
        </div>
      </div>
    </section>
    ...
    <section className="section-space bg-navy text-white"><div className="site-container grid gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
      <div><p className="eyebrow text-white/55">Built in Canada</p><h2 className="mt-7 max-w-4xl text-[clamp(3rem,6vw,6.4rem)] font-semibold leading-[0.94] tracking-[-0.055em]">Local roots.<br />A wider outlook.</h2></div>

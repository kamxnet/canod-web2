...
export default function PrivacyPage() {
  return <div className="publication-page">
    ...
    <div className="site-container document-body article-body">
      ...
      <section><h2>The dock checker and Practical Tech Brief</h2><p>The USB-C dock checker runs in your browser. Its answers are held in page memory and are not sent to CANOD, an API or an analytics service. Downloading a checklist creates a text file locally in your browser. The tool does not inspect your hardware.</p><p>Practical Tech Brief is a coming-soon notice, not an active signup form. The website does not currently collect email addresses for a newsletter.</p></section>
